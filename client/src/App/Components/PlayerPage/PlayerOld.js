...
class Player extends React.Component {
  ...
  getChannels() {
    ...
    if ( this.props.youtubeLoggedIn && source === 'yt' && !this.state.channelsRequested ) {
      this.setState({channelsRequested:true})
      this.props.getYoutubeChannel(channels);
    }
    if ( !this.props.youtubeLoggedIn && source === 'yt' ) {
  ...
  //   console.log('shouldComponentUpdate', nextProps.location.pathname !== this.props.location.pathname, nextProps, this.props);
  //   if ( nextProps.location.pathname !== this.props.location.pathname && !this.state.channelsRequested ) {
  //     this.setState({loaded:false})
  //     if ( nextProps.match.params.source === 'tw' ) {
  //       nextProps.resetTwitchChannel();
  //       nextProps.resetTwitchChannelDetails();
  //     }
  //     if ( nextProps.match.params.source === 'yt' ) {
  //       nextProps.resetYoutubeChannel();
  //       nextProps.resetYoutubeChannelDetails();
  //     }
  //     return false;
  //   }
  //   return true;
  ...
  //   console.log('componentWillUpdate', nextProps.location.pathname !== this.props.location.pathname, nextProps, this.props);
  ...
  componentWillReceiveProps(nextProps) {
    ...
    console.log('in componentWillReceiveProps', channels, uniqueChannels, this.state.channelsRequested, this.props.channelDetails, nextProps.channelDetails);
    ...
    if ( uniqueChannels.length !== channels.length ) {
      ...
      if ( source === 'tw' && this.props.channelDetails !== nextProps.channelDetails && nextProps.channelDetails.length > 0 ) {
        this.setState({loaded:true})
      ...
      if ( source === 'yt' && this.props.youtubeChannelDetails !== nextProps.youtubeChannelDetails && nextProps.youtubeChannelDetails.length > 0 ) {
        this.setState({loaded:true})
  ...
  render() {
    ...
    if ( source === 'tw' || (source === 'yt' && !!this.props.youtubeLoggedIn) ) {
      ...
      if ( playerChannels.length === 0 || playerChannelDetails.length === 0 || this.state.loaded === false) 
